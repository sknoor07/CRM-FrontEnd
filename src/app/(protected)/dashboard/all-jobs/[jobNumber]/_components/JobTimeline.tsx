...
import { JobStatusHistory } from "@/features/cs/types/job-details.types";
                    ...
                    {history.map((entry, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Timeline indicator */}
                                <div
                                    className={`relative z-10 flex h-6 w-6 shrink-0 items-center justify-center rounded-full border bg-background ${isLast ? "border-primary" : "border-border"
                                        }`}
                                >
                                    {isLast ? (
